...
from mxconsole.plugins.debugger import debugger_plugin
#from mxconsole.plugins.projector import projector_plugin
#from mxconsole.plugins.text import text_plugin
...
class TensorBoardWSGIApp(object):
  ...
  def _serve_static_file(self, request, path):
    ...
    path = os.path.join('components', orig_path)
