...
==============================================================================*/
describe('fast tab switch', function () {
    window.HTMLImports.whenReady(function () {
        var tb = d3.select('tf-tensorboard');
        var tabs = tb.node().$.tabs;
        ...
        var eventsTabIndex = TF.Globals.TABS.indexOf('events');
        var imagesTabIndex = TF.Globals.TABS.indexOf('images');
        var graphTabIndex = TF.Globals.TABS.indexOf('graphs');
        // Listen for when the events tab rendered.
        tb.on('rendered', function () {
            it('switching to graph tab and immediately to images', function (done) {
                ...
                tb.on('rendered', function () { return done(); });
