...
# source: mxconsole/protobuf/attr_value.proto
...
from mxconsole.protobuf import tensor_pb2 as mxconsole_dot_protobuf_dot_tensor__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='mxconsole/protobuf/attr_value.proto',
  package='mxconsole',
  syntax='proto3',
  serialized_pb=_b('\n#mxconsole/protobuf/attr_value.proto\x12\tmxconsole\x1a\x1fmxconsole/protobuf/tensor.proto\x1a%mxconsole/protobuf/tensor_shape.proto\x1a\x1emxconsole/protobuf/types.proto\"\x9d\x04\n\tAttrValue\x12\x0b\n\x01s\x18\x02 \x01(\x0cH\x00\x12\x0b\n\x01i\x18\x03 \x01(\x03H\x00\x12\x0b\n\x01\x66\x18\x04 \x01(\x02H\x00\x12\x0b\n\x01\x62\x18\x05 \x01(\x08H\x00\x12#\n\x04type\x18\x06 \x01(\x0e\x32\x13.mxconsole.DataTypeH\x00\x12,\n\x05shape\x18\x07 \x01(\x0b\x32\x1b.mxconsole.TensorShapeProtoH\x00\x12(\n\x06tensor\x18\x08 \x01(\x0b\x32\x16.mxconsole.TensorProtoH\x00\x12.\n\x04list\x18\x01 \x01(\x0b\x32\x1e.mxconsole.AttrValue.ListValueH\x00\x12\'\n\x04\x66unc\x18\n \x01(\x0b\x32\x17.mxconsole.NameAttrListH\x00\x12\x15\n\x0bplaceholder\x18\t \x01(\tH\x00\x1a\xe5\x01\n\tListValue\x12\t\n\x01s\x18\x02 \x03(\x0c\x12\r\n\x01i\x18\x03 \x03(\x03\x42\x02\x10\x01\x12\r\n\x01\x66\x18\x04 \x03(\x02\x42\x02\x10\x01\x12\r\n\x01\x62\x18\x05 \x03(\x08\x42\x02\x10\x01\x12%\n\x04type\x18\x06 \x03(\x0e\x32\x13.mxconsole.DataTypeB\x02\x10\x01\x12*\n\x05shape\x18\x07 \x03(\x0b\x32\x1b.mxconsole.TensorShapeProto\x12&\n\x06tensor\x18\x08 \x03(\x0b\x32\x16.mxconsole.TensorProto\x12%\n\x04\x66unc\x18\t \x03(\x0b\x32\x17.mxconsole.NameAttrListB\x07\n\x05value\"\x90\x01\n\x0cNameAttrList\x12\x0c\n\x04name\x18\x01 \x01(\t\x12/\n\x04\x61ttr\x18\x02 \x03(\x0b\x32!.mxconsole.NameAttrList.AttrEntry\x1a\x41\n\tAttrEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12#\n\x05value\x18\x02 \x01(\x0b\x32\x14.mxconsole.AttrValue:\x02\x38\x01\x42%\n\rorg.mxconsoleB\x0f\x41ttrValueProtosP\x01\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[mxconsole_dot_protobuf_dot_tensor__pb2.DESCRIPTOR,mxconsole_dot_protobuf_dot_tensor__shape__pb2.DESCRIPTOR,mxconsole_dot_protobuf_dot_types__pb2.DESCRIPTOR,])
...
_ATTRVALUE_LISTVALUE = _descriptor.Descriptor(
  name='ListValue',
  full_name='mxconsole.AttrValue.ListValue',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='s', full_name='mxconsole.AttrValue.ListValue.s', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='i', full_name='mxconsole.AttrValue.ListValue.i', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='f', full_name='mxconsole.AttrValue.ListValue.f', index=2,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='b', full_name='mxconsole.AttrValue.ListValue.b', index=3,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='type', full_name='mxconsole.AttrValue.ListValue.type', index=4,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='shape', full_name='mxconsole.AttrValue.ListValue.shape', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tensor', full_name='mxconsole.AttrValue.ListValue.tensor', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='func', full_name='mxconsole.AttrValue.ListValue.func', index=7,
...
_ATTRVALUE = _descriptor.Descriptor(
  name='AttrValue',
  full_name='mxconsole.AttrValue',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='s', full_name='mxconsole.AttrValue.s', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='i', full_name='mxconsole.AttrValue.i', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='f', full_name='mxconsole.AttrValue.f', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='b', full_name='mxconsole.AttrValue.b', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='type', full_name='mxconsole.AttrValue.type', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='shape', full_name='mxconsole.AttrValue.shape', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tensor', full_name='mxconsole.AttrValue.tensor', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='list', full_name='mxconsole.AttrValue.list', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='func', full_name='mxconsole.AttrValue.func', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='placeholder', full_name='mxconsole.AttrValue.placeholder', index=9,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='value', full_name='mxconsole.AttrValue.value',
...
_NAMEATTRLIST_ATTRENTRY = _descriptor.Descriptor(
  name='AttrEntry',
  full_name='mxconsole.NameAttrList.AttrEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='mxconsole.NameAttrList.AttrEntry.key', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='mxconsole.NameAttrList.AttrEntry.value', index=1,
...
_NAMEATTRLIST = _descriptor.Descriptor(
  name='NameAttrList',
  full_name='mxconsole.NameAttrList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='mxconsole.NameAttrList.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='attr', full_name='mxconsole.NameAttrList.attr', index=1,
...
_ATTRVALUE_LISTVALUE.fields_by_name['type'].enum_type = mxconsole_dot_protobuf_dot_types__pb2._DATATYPE
_ATTRVALUE_LISTVALUE.fields_by_name['shape'].message_type = mxconsole_dot_protobuf_dot_tensor__shape__pb2._TENSORSHAPEPROTO
_ATTRVALUE_LISTVALUE.fields_by_name['tensor'].message_type = mxconsole_dot_protobuf_dot_tensor__pb2._TENSORPROTO
_ATTRVALUE_LISTVALUE.fields_by_name['func'].message_type = _NAMEATTRLIST
_ATTRVALUE_LISTVALUE.containing_type = _ATTRVALUE
_ATTRVALUE.fields_by_name['type'].enum_type = mxconsole_dot_protobuf_dot_types__pb2._DATATYPE
_ATTRVALUE.fields_by_name['shape'].message_type = mxconsole_dot_protobuf_dot_tensor__shape__pb2._TENSORSHAPEPROTO
_ATTRVALUE.fields_by_name['tensor'].message_type = mxconsole_dot_protobuf_dot_tensor__pb2._TENSORPROTO
...
AttrValue = _reflection.GeneratedProtocolMessageType('AttrValue', (_message.Message,), dict(
  ...
  ListValue = _reflection.GeneratedProtocolMessageType('ListValue', (_message.Message,), dict(
    ...
    __module__ = 'mxconsole.protobuf.attr_value_pb2'
    # @@protoc_insertion_point(class_scope:mxconsole.AttrValue.ListValue)
    ))
  ,
  DESCRIPTOR = _ATTRVALUE,
  __module__ = 'mxconsole.protobuf.attr_value_pb2'
  # @@protoc_insertion_point(class_scope:mxconsole.AttrValue)
  ))
...
NameAttrList = _reflection.GeneratedProtocolMessageType('NameAttrList', (_message.Message,), dict(
  ...
  AttrEntry = _reflection.GeneratedProtocolMessageType('AttrEntry', (_message.Message,), dict(
    ...
    __module__ = 'mxconsole.protobuf.attr_value_pb2'
    # @@protoc_insertion_point(class_scope:mxconsole.NameAttrList.AttrEntry)
    ))
  ,
  DESCRIPTOR = _NAMEATTRLIST,
  __module__ = 'mxconsole.protobuf.attr_value_pb2'
  # @@protoc_insertion_point(class_scope:mxconsole.NameAttrList)
  ))
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\rorg.mxconsoleB\017AttrValueProtosP\001\370\001\001'))
