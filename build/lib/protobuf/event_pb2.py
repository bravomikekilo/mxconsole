...
# source: mxconsole/protobuf/event.proto
...
from mxconsole.protobuf import summary_pb2 as mxconsole_dot_protobuf_dot_summary__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='mxconsole/protobuf/event.proto',
  package='mxconsole',
  syntax='proto3',
  serialized_pb=_b('\n\x1emxconsole/protobuf/event.proto\x12\tmxconsole\x1a mxconsole/protobuf/summary.proto\"\xb7\x02\n\x05\x45vent\x12\x11\n\twall_time\x18\x01 \x01(\x01\x12\x0c\n\x04step\x18\x02 \x01(\x03\x12\x16\n\x0c\x66ile_version\x18\x03 \x01(\tH\x00\x12\x13\n\tgraph_def\x18\x04 \x01(\x0cH\x00\x12%\n\x07summary\x18\x05 \x01(\x0b\x32\x12.mxconsole.SummaryH\x00\x12,\n\x0blog_message\x18\x06 \x01(\x0b\x32\x15.mxconsole.LogMessageH\x00\x12,\n\x0bsession_log\x18\x07 \x01(\x0b\x32\x15.mxconsole.SessionLogH\x00\x12;\n\x13tagged_run_metadata\x18\x08 \x01(\x0b\x32\x1c.mxconsole.TaggedRunMetadataH\x00\x12\x18\n\x0emeta_graph_def\x18\t \x01(\x0cH\x00\x42\x06\n\x04what\"\x94\x01\n\nLogMessage\x12*\n\x05level\x18\x01 \x01(\x0e\x32\x1b.mxconsole.LogMessage.Level\x12\x0f\n\x07message\x18\x02 \x01(\t\"I\n\x05Level\x12\x0b\n\x07UNKNOWN\x10\x00\x12\t\n\x05\x44\x45\x42UG\x10\n\x12\x08\n\x04INFO\x10\x14\x12\x08\n\x04WARN\x10\x1e\x12\t\n\x05\x45RROR\x10(\x12\t\n\x05\x46\x41TAL\x10\x32\"\xb5\x01\n\nSessionLog\x12\x33\n\x06status\x18\x01 \x01(\x0e\x32#.mxconsole.SessionLog.SessionStatus\x12\x17\n\x0f\x63heckpoint_path\x18\x02 \x01(\t\x12\x0b\n\x03msg\x18\x03 \x01(\t\"L\n\rSessionStatus\x12\x16\n\x12STATUS_UNSPECIFIED\x10\x00\x12\t\n\x05START\x10\x01\x12\x08\n\x04STOP\x10\x02\x12\x0e\n\nCHECKPOINT\x10\x03\"6\n\x11TaggedRunMetadata\x12\x0b\n\x03tag\x18\x01 \x01(\t\x12\x14\n\x0crun_metadata\x18\x02 \x01(\x0c\x42!\n\rorg.mxconsoleB\x0b\x45ventProtosP\x01\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[mxconsole_dot_protobuf_dot_summary__pb2.DESCRIPTOR,])
...
_LOGMESSAGE_LEVEL = _descriptor.EnumDescriptor(
  name='Level',
  full_name='mxconsole.LogMessage.Level',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_SESSIONLOG_SESSIONSTATUS = _descriptor.EnumDescriptor(
  name='SessionStatus',
  full_name='mxconsole.SessionLog.SessionStatus',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_EVENT = _descriptor.Descriptor(
  name='Event',
  full_name='mxconsole.Event',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='wall_time', full_name='mxconsole.Event.wall_time', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='step', full_name='mxconsole.Event.step', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='file_version', full_name='mxconsole.Event.file_version', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='graph_def', full_name='mxconsole.Event.graph_def', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='summary', full_name='mxconsole.Event.summary', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='log_message', full_name='mxconsole.Event.log_message', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='session_log', full_name='mxconsole.Event.session_log', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tagged_run_metadata', full_name='mxconsole.Event.tagged_run_metadata', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='meta_graph_def', full_name='mxconsole.Event.meta_graph_def', index=8,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='what', full_name='mxconsole.Event.what',
...
_LOGMESSAGE = _descriptor.Descriptor(
  name='LogMessage',
  full_name='mxconsole.LogMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='level', full_name='mxconsole.LogMessage.level', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='message', full_name='mxconsole.LogMessage.message', index=1,
...
_SESSIONLOG = _descriptor.Descriptor(
  name='SessionLog',
  full_name='mxconsole.SessionLog',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='mxconsole.SessionLog.status', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='checkpoint_path', full_name='mxconsole.SessionLog.checkpoint_path', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='msg', full_name='mxconsole.SessionLog.msg', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TAGGEDRUNMETADATA = _descriptor.Descriptor(
  ...
  full_name='mxconsole.TaggedRunMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tag', full_name='mxconsole.TaggedRunMetadata.tag', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='run_metadata', full_name='mxconsole.TaggedRunMetadata.run_metadata', index=1,
...
_EVENT.fields_by_name['summary'].message_type = mxconsole_dot_protobuf_dot_summary__pb2._SUMMARY
...
Event = _reflection.GeneratedProtocolMessageType('Event', (_message.Message,), dict(
  DESCRIPTOR = _EVENT,
  __module__ = 'mxconsole.protobuf.event_pb2'
  # @@protoc_insertion_point(class_scope:mxconsole.Event)
  ))
...
LogMessage = _reflection.GeneratedProtocolMessageType('LogMessage', (_message.Message,), dict(
  ...
  __module__ = 'mxconsole.protobuf.event_pb2'
  # @@protoc_insertion_point(class_scope:mxconsole.LogMessage)
  ))
...
SessionLog = _reflection.GeneratedProtocolMessageType('SessionLog', (_message.Message,), dict(
  ...
  __module__ = 'mxconsole.protobuf.event_pb2'
  # @@protoc_insertion_point(class_scope:mxconsole.SessionLog)
  ))
...
TaggedRunMetadata = _reflection.GeneratedProtocolMessageType('TaggedRunMetadata', (_message.Message,), dict(
  ...
  __module__ = 'mxconsole.protobuf.event_pb2'
  # @@protoc_insertion_point(class_scope:mxconsole.TaggedRunMetadata)
  ))
_sym_db.RegisterMessage(TaggedRunMetadata)


DESCRIPTOR.has_options = True
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\rorg.mxconsoleB\013EventProtosP\001\370\001\001'))
