...
# source: mxconsole/protobuf/summary.proto
...
_SUMMARYDESCRIPTION = _descriptor.Descriptor(
  ...
  full_name='mxconsole.SummaryDescription',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type_hint', full_name='mxconsole.SummaryDescription.type_hint', index=0,
...
_HISTOGRAMPROTO = _descriptor.Descriptor(
  name='HistogramProto',
  full_name='mxconsole.HistogramProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min', full_name='mxconsole.HistogramProto.min', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max', full_name='mxconsole.HistogramProto.max', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num', full_name='mxconsole.HistogramProto.num', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sum', full_name='mxconsole.HistogramProto.sum', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sum_squares', full_name='mxconsole.HistogramProto.sum_squares', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bucket_limit', full_name='mxconsole.HistogramProto.bucket_limit', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='bucket', full_name='mxconsole.HistogramProto.bucket', index=6,
...
_SUMMARY_IMAGE = _descriptor.Descriptor(
  name='Image',
  full_name='mxconsole.Summary.Image',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='height', full_name='mxconsole.Summary.Image.height', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='width', full_name='mxconsole.Summary.Image.width', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='colorspace', full_name='mxconsole.Summary.Image.colorspace', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='encoded_image_string', full_name='mxconsole.Summary.Image.encoded_image_string', index=3,
...
_SUMMARY_AUDIO = _descriptor.Descriptor(
  name='Audio',
  full_name='mxconsole.Summary.Audio',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='sample_rate', full_name='mxconsole.Summary.Audio.sample_rate', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_channels', full_name='mxconsole.Summary.Audio.num_channels', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='length_frames', full_name='mxconsole.Summary.Audio.length_frames', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='encoded_audio_string', full_name='mxconsole.Summary.Audio.encoded_audio_string', index=3,
      number=4, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='content_type', full_name='mxconsole.Summary.Audio.content_type', index=4,
...
_SUMMARY_VALUE = _descriptor.Descriptor(
  name='Value',
  full_name='mxconsole.Summary.Value',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='node_name', full_name='mxconsole.Summary.Value.node_name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tag', full_name='mxconsole.Summary.Value.tag', index=1,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='simple_value', full_name='mxconsole.Summary.Value.simple_value', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='obsolete_old_style_histogram', full_name='mxconsole.Summary.Value.obsolete_old_style_histogram', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='image', full_name='mxconsole.Summary.Value.image', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='histo', full_name='mxconsole.Summary.Value.histo', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='audio', full_name='mxconsole.Summary.Value.audio', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tensor', full_name='mxconsole.Summary.Value.tensor', index=7,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='value', full_name='mxconsole.Summary.Value.value',
...
_SUMMARY = _descriptor.Descriptor(
  name='Summary',
  full_name='mxconsole.Summary',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='mxconsole.Summary.value', index=0,
...
_SUMMARY_VALUE.fields_by_name['tensor'].message_type = mxconsole_dot_protobuf_dot_tensor__pb2._TENSORPROTO
...
SummaryDescription = _reflection.GeneratedProtocolMessageType('SummaryDescription', (_message.Message,), dict(
  ...
  __module__ = 'mxconsole.protobuf.summary_pb2'
  # @@protoc_insertion_point(class_scope:mxconsole.SummaryDescription)
  ))
...
HistogramProto = _reflection.GeneratedProtocolMessageType('HistogramProto', (_message.Message,), dict(
  ...
  __module__ = 'mxconsole.protobuf.summary_pb2'
  # @@protoc_insertion_point(class_scope:mxconsole.HistogramProto)
  ))
...
Summary = _reflection.GeneratedProtocolMessageType('Summary', (_message.Message,), dict(
  ...
  Image = _reflection.GeneratedProtocolMessageType('Image', (_message.Message,), dict(
    ...
    __module__ = 'mxconsole.protobuf.summary_pb2'
    # @@protoc_insertion_point(class_scope:mxconsole.Summary.Image)
    ))
  ,
  ...
  Audio = _reflection.GeneratedProtocolMessageType('Audio', (_message.Message,), dict(
    ...
    __module__ = 'mxconsole.protobuf.summary_pb2'
    # @@protoc_insertion_point(class_scope:mxconsole.Summary.Audio)
    ))
  ,
  ...
  Value = _reflection.GeneratedProtocolMessageType('Value', (_message.Message,), dict(
    ...
    __module__ = 'mxconsole.protobuf.summary_pb2'
    # @@protoc_insertion_point(class_scope:mxconsole.Summary.Value)
    ))
  ,
  DESCRIPTOR = _SUMMARY,
  __module__ = 'mxconsole.protobuf.summary_pb2'
  # @@protoc_insertion_point(class_scope:mxconsole.Summary)
  ))
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\rorg.mxconsoleB\rSummaryProtosP\001\370\001\001'))
